...
export default (natives, commandHandler, nativeHandler, commands, keywords) => {
    ...
    commands.forEach(command => {
        commandHandler.on(command.name, args => {
            ...
            parsedArgs.every(argument => argument.isValid)
                ...
                : commandHandler.emit('argument_error', command, parsedArgs
